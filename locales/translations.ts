...
const fr = {
  ...
  form: {
    ...
    optHome: 'Au domicile (Gouy-Lez-Piéton)',
    optOnline: 'En visio',
    ...
    reasons: ['Examen important', 'Interrogation', 'Remise à niveau', 'Manque de méthode'],
    ...
    msg: {
      ...
      message: 'Message',
      closing: 'Merci d’avance, et à bientôt !',
      modalityHome: 'Au domicile (Gouy-Lez-Piéton)',
...
const en: typeof fr = {
  ...
  form: {
    ...
    optHome: 'At my place (Gouy-Lez-Piéton)',
    optOnline: 'Online',
    ...
    reasons: ['Major exam', 'Test', 'Catch-up', 'Study method'],
    ...
    msg: {
      ...
      message: 'Message',
      closing: 'Thanks in advance, and see you soon!',
      modalityHome: 'At my place (Gouy-Lez-Piéton)',
...
const nl: typeof fr = {
  ...
  form: {
    ...
    optHome: 'Bij mij thuis (Gouy-Lez-Piéton)',
    optOnline: 'Online',
    btnContinue: 'Verder',
    btnBack: 'Terug',
    ...
    reasons: ['Belangrijk examen', 'Toets', 'Bijwerken', 'Studiemethode'],
    ...
    msg: {
      ...
      message: 'Bericht',
      closing: 'Alvast bedankt, tot binnenkort!',
      modalityHome: 'Bij mij thuis (Gouy-Lez-Piéton)',
      modalityOnline: 'Online',
